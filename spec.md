...
- Quality bar dùng cho lượt đo chẩn đoán: **Đạt khi ≥ 80% case đã lên lịch pass, đồng thời `error = 0`, `blocked = 0` và lớp khó đạt ≥ 80%.** Quality bar này được giữ nguyên khi so sánh các lượt chạy; không đổi ngưỡng để làm đẹp số liệu. Vì quality bar chưa được ghi vào spec trước hạn CP4, đây là tuyên bố vận hành bổ sung sau hạn chốt, không tự nhận thay thế điều kiện checkpoint.
